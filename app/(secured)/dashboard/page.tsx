            ...
            <div className="space-y-2">
              ...
              {role === "student" && (
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{profile.classroom || "Not set"}</span>
                </div>
              )}
            </div>
          </CardContent>
        ...
        {role === "teacher" && (
          <>
            ...
            <Card>
              ...
              <CardContent>
                {teacherGrades.length > 0 ? (
                  ...
                  <p className="text-muted-foreground">No grades assigned yet</p>
                )}
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="mb-4">Quickly create personalized comments for student reports.</p>
                <a 
        ...
        {role === "student" && (
          <>
                ...
                {profile.hasConcession ? (
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{profile.concessionType}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Extra Time:</span>
                      <span className="font-medium">{profile.concessionTime} minutes</span>
                    </div>
                  </div>
                ) : (
            ...
            <Card>
              ...
              <CardContent>
                <p className="mb-4">Access your subject information and resources.</p>
                <a 
